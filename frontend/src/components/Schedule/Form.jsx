...
export default function Form({ formData, setFormData }) {
  ...
  return (
    <>
      {togglePopUp && (<PopUp />)}
      {togglePopUp && (<div className="w-full h-full absolute top-[100px] left-[50%] translate-x-[-50%] z-10 bg-transparent backdrop-blur-extra-sm" onClick={handlePopUp}></div>)}
      <div className="flex py-[20px] px-[30px] pt-[38px]">
        <div className="w-full">
          ...
          <div className="mt-[60px]">
            <Button onClick={() => console.log(formData)}>Agendar</Button>
          </div>
        </div>
      </div>
    </>
